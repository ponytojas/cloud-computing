...
export const createProduct = async (
  ...
  const query = `INSERT INTO "product" (name, pricing, description, rating, picture, created_at) VALUES ($1, $2, $3, $4, $5, $6) RETURNING product_id`;
  const values = [name, pricing, description, rating, picture, createdAt];
